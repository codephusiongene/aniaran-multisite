...
Please install and activate it before starting to use the theme Confidant.
...
Theme documentation is available on https://doc.themerex/confidant/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Confidant is Fontello.
