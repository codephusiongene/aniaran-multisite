...
if ( ! function_exists( 'confidant_trx_addons_get_css' ) ) {
	add_filter( 'confidant_filter_get_css', 'confidant_trx_addons_get_css', 10, 2 );
	function confidant_trx_addons_get_css( $css, $args ) {
