...
if ( ! function_exists( 'confidant_woocommerce_get_css' ) ) {
	add_filter( 'confidant_filter_get_css', 'confidant_woocommerce_get_css', 10, 2 );
	function confidant_woocommerce_get_css( $css, $args ) {
...
.product-title, aside.woocommerce .product-title,
...
$fdir = confidant_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
